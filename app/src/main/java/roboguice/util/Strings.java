...
class Strings {
     ...
     */
    /*
    private static <T> String joinAnd(final String delimiter, final String lastDelimiter, final Collection<T> objs) {
    ...
    */
    ...
    public static String[] chunk( String str, int chunkSize ) {
        ...
        try {
            ...
            System.out.println("str.substring(i*chunkSize,(i*chunkSize)+chunkSize<len ? (i*chunkSize)+chunkSize : len) out of bounds");
        }
    ...
    */
    ...
    /*
    private static String namedFormat(String str, Map<String, String> substitutions) {
